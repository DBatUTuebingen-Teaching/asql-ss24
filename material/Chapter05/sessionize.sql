...
INSERT INTO log(uid, ts) VALUES
  ('Cop', '2024-05-25 07:25:12'),
  ('Cop', '2024-05-25 07:25:18'),
  ('Cop', '2024-05-25 07:25:21'),
  ('Spy', '2024-05-25 08:01:55'),
  ('Spy', '2024-05-25 08:02:07'),
  ('Spy', '2024-05-25 08:05:30'),
  ('Spy', '2024-05-25 08:05:53'),
  ('Spy', '2024-05-25 08:06:19'), -- ⎱ sessions by Spy and Cop within
  ('Cop', '2024-05-25 08:06:30'), -- ⎰ 30 seconds, still *two* sessions ⇒ partition by uid ⁑
  ('Cop', '2024-05-25 08:06:42'),
  ('Cop', '2024-05-25 18:32:07'),
  ('Cop', '2024-05-25 18:32:27'),
  ('Cop', '2024-05-25 18:32:44'),
  ('Cop', '2024-05-25 18:33:00'),
  ('Spy', '2024-05-25 22:20:06'),
  ('Spy', '2024-05-25 22:20:16');

-- After this time of inactivity, a session is considered complete
CREATE OR REPLACE MACRO inactivity() AS '30 seconds';
